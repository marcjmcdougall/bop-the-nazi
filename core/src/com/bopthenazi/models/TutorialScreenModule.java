...
public class TutorialScreenModule extends Group {
	...
	public void doAnimate(){
		...
		alpha.addAction(Actions.sequence(/*Actions.delay(0.5f),*/ Actions.fadeIn(1.0f)));
		bg.addAction(Actions.sequence(Actions.moveBy(0.0f, 2000.0f)/*, Actions.delay(0.5f)*/, Actions.moveBy(0.0f, -2000.0f, 1.0f, Interpolation.pow4)));
		ok.addAction(Actions.sequence(Actions.moveBy(0.0f, 2000.0f)/*, Actions.delay(0.5f)*/, Actions.moveBy(0.0f, -2000.0f, 1.0f, Interpolation.pow4)));
